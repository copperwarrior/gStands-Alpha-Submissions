function EFFECT:Init( data )
    ...
    particle1:SetPos(self.Position + Vector(math.random(-20,20),math.random(-20,20),math.random(-20,80)))
    particle1:SetBounce(0.3)
    particle1:SetCollide(true)
    particle1:SetColor(255,255,0)
    particle1:SetDieTime(3)
    particle1:SetStartAlpha(255)
    particle1:SetEndAlpha(100)
    particle1:SetEndSize(2)
    particle1:SetStartSize(5)
    particle1:SetGravity(Vector(0,0,0))
    particle1:SetRollDelta(math.random(-1,1))
    
    particle3:SetPos(self.Position + Vector(math.random(-20,20),math.random(-20,20),math.random(-20,80)))
    ...
    particle3:SetEndSize(2)
    particle3:SetStartSize(5)
    particle3:SetGravity(Vector(0,0,0))
    particle3:SetRollDelta(math.random(-1,1))
    
    particle4:SetPos(self.Position + Vector(math.random(-20,20),math.random(-20,20),math.random(-20,80)))
    ...
    particle4:SetEndSize(2)
    particle4:SetStartSize(5)
