function EFFECT:Init( data )
    ...
    particle1:SetVelocity((data:GetNormal() + Vector(0,0,0.3)) * 500)
    ...
    particle3:SetVelocity((data:GetNormal() + Vector(0,0,0.3)) * 500)
    ...
    particle4:SetVelocity((data:GetNormal() + Vector(0,0,0.3)) * 1000)
